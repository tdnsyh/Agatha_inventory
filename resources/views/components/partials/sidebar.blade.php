     ...
     <div class="sidebar-wrapper active">
         ...
         <div class="sidebar-menu">
             <ul class="menu">
                 ...
                 <li
                     class="sidebar-item  {{ request()->routeIs('product.*', 'barcode-scanner') ? 'active' : '' }} has-sub">
                 ...
                 <li class="sidebar-item {{ request()->routeIs('production.*') ? 'active' : '' }} has-sub">
                     ...
                     <ul class="submenu">
                         <li
                             class="submenu-item {{ request()->routeIs('production.index', 'production.show', 'production.create', 'production.update') ? 'active' : '' }}">
                             <a class="submenu-link" href="{{ route('production.index') }}">Production List</a>
                         </li>

                         <li
                             class="submenu-item {{ request()->routeIs('production.request', 'production.request.create') ? 'active' : '' }}">
                 ...
                 <li class="sidebar-item {{ request()->routeIs('sales.*') ? 'active' : '' }} has-sub">
                     ...
                     <ul class="submenu">
                         <li
                             class="submenu-item {{ request()->routeIs('sales.index', 'sales.show', 'sales.create', 'sales.update') ? 'active' : '' }}">
                 ...
                 <li class="sidebar-item {{ request()->routeIs('inventory.*') ? 'active' : '' }} has-sub">
                     ...
                     <ul class="submenu">
                         ...
                         <li
                             class="submenu-item {{ request()->routeIs('inventory.request.index', 'inventory.request.show', 'inventory.request.create', 'inventory.request.update', 'inventory.request.update-status') ? 'active' : '' }}">
                             <a class="submenu-link" href="{{ route('inventory.request.index') }}">Request
                                 Production</a>
                         </li>
