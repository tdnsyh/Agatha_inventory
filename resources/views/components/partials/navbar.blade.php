    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ms-auto mb-lg-0">
        <li class="nav-item dropdown me-1">
          <a data-bs-toggle="dropdown" aria-expanded="false" class="nav-link active dropdown-toggle text-gray-600" href="#">
            <i class='bi bi-envelope bi-sub fs-4'></i>
          </a>
          <ul aria-labelledby="dropdownMenuButton" class="dropdown-menu  dropdown-menu-lg-end">
            <li>
